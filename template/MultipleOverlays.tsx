 ...
 *
 * This example demonstrates how to use useOverlayBack with multiple overlays.
 * Each overlay has a unique ID, allowing them to work independently.
 * The back button will close the most recently opened overlay.
 */
export default function MultipleOverlays() {
  ...
  return (
    <div style={{ padding: '20px' }}>
      <h1 style={{ marginBottom: '24px' }}>Multiple Overlays Demo</h1>
